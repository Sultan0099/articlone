const assets = {
  ...
  createblog:'/images/createblog.png',
  getapi:'/images/getapi.png',
  projectsetting:'/images/projectsetting.png',
  ...
  testworking: '/images/testworking.svg',
  testworkinglg: '/images/testworkinglg.svg',
  testworkingsm: '/images/testworkingsm.svg',
  testworkingxs: '/images/testworkingxs.svg',
  notfound: '/images/notfound.png',
  twitter: '/images/twitter.svg',
  logoIcon: '/images/logoicon.svg',
  github: '/images/github.svg',
  in: '/images/in.svg',
  whiteLogo: '/images/logo-white.svg',
  server: '/images/server.png',
  sample: 'images/sample.mkv',
  profile: '/images/profile.png',
  createimg: '/images/create.png',
